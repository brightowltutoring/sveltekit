import{S as v,i as _,s as k,k as x,q as M,V as j,l as g,m as $,r as A,h as i,n as o,a0 as q,L as p,A as y,o as C,_ as I}from"./index-82240eb1.js";import{k as S}from"./katex-15be85e5.js";const{document:f}=I;function E(b){let t,a,c,n,h;return{c(){t=x("link"),a=x("script"),c=M(`MathJax = {
  ...
  `),n=x("script"),this.h()},l(u){const e=j('[data-svelte="svelte-15ncbow"]',f.head);t=g(e,"LINK",{rel:!0,href:!0,integrity:!0,crossorigin:!0}),a=g(e,"SCRIPT",{});var l=$(a);c=A(l,`MathJax = {
      // startup: { typeset: false },
      // startup: { elements: ["[m]"] },
      loader: { load: ["[tex]/physics", "[tex]/cancel"] },
      tex: {
