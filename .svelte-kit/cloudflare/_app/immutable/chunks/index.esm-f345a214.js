import{az as An,F as Vn,b as Me,d as Dn,c as Fn,aA as Nn,aB as xn,g as b,aC as Rn,_ as qn,C as Pn,r as be,aD as Jt,aE as Ln}from"./firebase-cb9dba95.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K=new An("@firebase/firestore");function jr(n){K.setLogLevel(n)}function G(n,...t){if(K.logLevel<=Jt.DEBUG){const e=t.map(Xt);K.debug(`Firestore (${ot}): ${n}`,...e)}}function Rt(n,...t){if(K.logLevel<=Jt.ERROR){const e=t.map(Xt);K.error(`Firestore (${ot}): ${n}`,...e)}}function $e(n,...t){if(K.logLevel<=Jt.WARN){const e=t.map(Xt);K.warn(`Firestore (${ot}): ${n}`,...e)}}function Xt(n){if(typeof n=="string")return n;try{return t=n,JSON.stringify(t)}catch{return n}/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Te="ok",Zt="cancelled",rt="unknown",h="invalid-argument",Ue="deadline-exceeded",te="not-found",On="already-exists",Be="permission-denied",Et="unauthenticated",je="resource-exhausted",$="failed-precondition",ee="aborted",ze="out-of-range",ne="unimplemented",Ke="internal",Ge="unavailable",Cn="data-loss";class c extends Vn{constructor(t,e){super(t,e),this.code=t,this.message=e,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function He(n){return n==null}function St(n){return n===0&&1/n==-1/0}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(m=ke||(ke={}))[m.OK=0]="OK",m[m.CANCELLED=1]="CANCELLED",m[m.UNKNOWN=2]="UNKNOWN",m[m.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",m[m.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",m[m.NOT_FOUND=5]="NOT_FOUND",m[m.ALREADY_EXISTS=6]="ALREADY_EXISTS",m[m.PERMISSION_DENIED=7]="PERMISSION_DENIED",m[m.UNAUTHENTICATED=16]="UNAUTHENTICATED",m[m.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",m[m.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",m[m.ABORTED=10]="ABORTED",m[m.OUT_OF_RANGE=11]="OUT_OF_RANGE",m[m.UNIMPLEMENTED=12]="UNIMPLEMENTED",m[m.INTERNAL=13]="INTERNAL",m[m.UNAVAILABLE=14]="UNAVAILABLE",m[m.DATA_LOSS=15]="DATA_LOSS";class Hn extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const e=t.ssl?"https":"http";this.p=e+"://"+t.host,this.g="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}get v(){return!1}I(t,e,r,s,i){const o=this.T(t,e);G("RestConnection","Sending: ",o,r);const a={};return this.A(a,s,i),this.R(t,o,a,r).then(u=>(G("RestConnection","Received: ",u),u),u=>{throw $e("RestConnection",`${t} failed with error: `,u,"url: ",o,"request:",r),u})}P(t,e,r,s,i,o){return this.I(t,e,r,s,i)}A(t,e,r){t["X-Goog-Api-Client"]="gl-js/ fire/"+ot,t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),e&&e.headers.forEach((s,i)=>t[i]=s),r&&r.headers.forEach((s,i)=>t[i]=s)}T(t,e){const r=Wn[t];return`${this.p}/v1/${e}:${r}`}}{constructor(t,e){super(t),this.V=e}N(t,e){throw new Error("Not supported by FetchConnection")}async R(t,e,r,s){var i;const o=JSON.stringify(s);let a;try{a=await this.V(e,{method:"POST",headers:r,body:o})}catch(u){throw new c(Ie(u.status),"Request failed with error: "+u.statusText)}if(!a.ok){let u=await a.json();Array.isArray(u)&&(u=u[0]);const l=(i=u==null?void 0:u.error)===null||i===void 0?void 0:i.message;throw new c(Ie(a.status),`Request failed with error: ${l!=null?l:a.statusText}`)}return a.json()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jn{static $(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=Math.floor(256/t.length)*t.length;let r="";for(;r.length<20;){const s=Yn(40);for(let i=0;i<s.length;++i)r.length<20&&s[i]<e&&(r+=t.charAt(s[i]%t.length))}return r}}function T(n,t){return n<t?-1:n>t?1:0}function ie(n,t,e){return n.length===t.length&&n.every((r,s)=>e(r,t[s]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Q{constructor(t){this.fields=t,t.sort(F.comparator)}static empty(){return new Q([])}unionWith(t){let e=new It(F.comparator);for(const r of this.fields)e=e.add(r);for(const r of t)e=e.add(r);return new Q(e.toArray())}covers(t){for(const e of this.fields)if(e.isPrefixOf(t))return!0;return!1}isEqual(t){return ie(this.fields,t.fields,(e,r)=>e.isEqual(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oe(n){var t,e;return((e=(((t=n==null?void 0:n.mapValue)===null||t===void 0?void 0:t.fields)||{}).__type__)===null||e===void 0?void 0:e.stringValue)==="server_timestamp"}function Ye(n){const t=n.mapValue.fields.__previous_value__;return oe(t)?Ye(t):t}function pt(n){const t=W(n.mapValue.fields.__local_write_time__.timestampValue);return new x(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vr extends class{}{constructor(t,e,r,s){super(),this.authCredentials=t,this.appCheckCredentials=e,this.connection=r,this.L=s,this.tt=!1}et(){if(this.tt)throw new c($,"The client has already been terminated.")}I(t,e,r){return this.et(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([s,i])=>this.connection.I(t,e,r,s,i)).catch(s=>{throw s.name==="FirebaseError"?(s.code===Et&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),s):new c(rt,s.toString())})}P(t,e,r,s){return this.et(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,o])=>this.connection.P(t,e,r,i,o,s)).catch(i=>{throw i.name==="FirebaseError"?(i.code===Et&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new c(rt,i.toString())})}terminate(){this.tt=!0}}async function ut(n,t){const e=at(n),r=un(e.L)+"/documents",s={writes:t.map(i=>pr(e.L,i))};await e.I("Commit",r,s)}async function dn(n,t){const e=at(n),r=un(e.L)+"/documents",s={documents:t.map(u=>Nt(e.L,u))},i=await e.P("BatchGetDocuments",r,s,t.length),o=new Map;i.forEach(u=>{const l=mr(e.L,u);o.set(l.key.toString(),l)});const a=[];return t.forEach(u=>{const l=o.get(u.toString());A(!!l),a.push(l)}),a}async function _r(n,t){const e=at(n),r=ln(e.L,Ft(t));return(await e.P("RunQuery",r.parent,{structuredQuery:r.structuredQuery})).filter(s=>!!s.document).map(s=>function(i,o,a){const u=Wt(i,o.name),l=Qt(o.updateTime),f=new N({mapValue:{fields:o.fields}}),d=C.newFoundDocument(u,l,f);return a&&d.setHasCommittedMutations(),a?d.setHasCommittedMutations():d}(e.L,s.document,void 0))}async function br(n,t){const e=at(n),r=function(i,o){const a=ln(i,o);return{structuredAggregationQuery:{aggregations:[{count:{},alias:"count_alias"}],structuredQuery:a.structuredQuery},parent:a.parent}}(e.L,Ft(t)),s=r.parent;return e.connection.v||delete r.parent,(await e.P("RunAggregationQuery",s,r,1)).filter(i=>!!i.result).map(i=>i.result.aggregateFields)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class X{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new c(h,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new F(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}function Jr(){return new X("__name__")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ir=/^__.*__$/;class Ar{constructor(t,e,r){this.data=t,this.fieldMask=e,this.fieldTransforms=r}toMutation(t,e){return this.fieldMask!==null?new le(t,this.data,this.fieldMask,e,this.fieldTransforms):new on(t,this.data,e,this.fieldTransforms)}}class mn{constructor(t,e,r){this.data=t,this.fieldMask=e,this.fieldTransforms=r}toMutation(t,e){return new le(t,this.data,this.fieldMask,e,this.fieldTransforms)}}function pn(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw g()}}class Mt{constructor(t,e,r,s,i,o){this.settings=t,this.databaseId=e,this.L=r,this.ignoreUndefinedProperties=s,i===void 0&&this.nt(),this.fieldTransforms=i||[],this.fieldMask=o||[]}get path(){return this.settings.path}get rt(){return this.settings.rt}st(t){return new Mt(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.L,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}it(t){var e;const r=(e=this.path)===null||e===void 0?void 0:e.child(t),s=this.st({path:r,ot:!1});return s.ut(t),s}ct(t){var e;const r=(e=this.path)===null||e===void 0?void 0:e.child(t),s=this.st({path:r,ot:!1});return s.nt(),s}at(t){return this.st({path:void 0,ot:!0})}ht(t){return xt(t,this.settings.methodName,this.settings.lt||!1,this.path,this.settings.ft)}contains(t){return this.fieldMask.find(e=>t.isPrefixOf(e))!==void 0||this.fieldTransforms.find(e=>t.isPrefixOf(e.field))!==void 0}nt(){if(this.path)for(let t=0;t<this.path.length;t++)this.ut(this.path.get(t))}ut(t){if(t.length===0)throw this.ht("Document fields must not be empty");if(pn(this.rt)&&Ir.test(t))throw this.ht('Document fields cannot begin and end with "__"')}}class Vr{constructor(t,e,r){this.databaseId=t,this.ignoreUndefinedProperties=e,this.L=r||he(t)}dt(t,e,r,s=!1){return new Mt({rt:t,methodName:e,ft:r,path:F.emptyPath(),ot:!1,lt:s},this.databaseId,this.L,this.ignoreUndefinedProperties)}}function tt(n){const t=n._freezeSettings(),e=he(n._databaseId);return new Vr(n._databaseId,!!t.ignoreUndefinedProperties,e)}function $t(n,t,e,r,s,i={}){const o=n.dt(i.merge||i.mergeFields?2:0,t,e,s);ge("Data must be an object, but it was:",o,r);const a=wn(r,o);let u,l;if(i.merge)u=new Q(o.fieldMask),l=o.fieldTransforms;else if(i.mergeFields){const f=[];for(const d of i.mergeFields){const p=Ht(t,d,e);if(!o.contains(p))throw new c(h,`Field '${p}' is specified in your field mask but missing from your input data.`);_n(f,p)||f.push(p)}u=new Q(f),l=o.fieldTransforms.filter(d=>u.covers(d.field))}else u=null,l=o.fieldTransforms;return new Ar(new N(a),u,l)}class wt extends Z{_toFieldTransform(t){if(t.rt!==2)throw t.rt===1?t.ht(`${this._methodName}() can only appear at the top level of your update data`):t.ht(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof wt}}function gn(n,t,e){return new Mt({rt:3,ft:t.settings.ft,methodName:n._methodName,ot:e},t.databaseId,t.L,t.ignoreUndefinedProperties)}class fe extends Z{_toFieldTransform(t){return new Lt(t.path,new en)}isEqual(t){return t instanceof fe}}class Dr extends Z{constructor(t,e){super(t),this.wt=e}_toFieldTransform(t){const e=gn(this,t,!0),r=this.wt.map(i=>et(i,e)),s=new nn(r);return new Lt(t.path,s)}isEqual(t){return this===t}}class Fr extends Z{constructor(t,e){super(t),this.wt=e}_toFieldTransform(t){const e=gn(this,t,!0),r=this.wt.map(i=>et(i,e)),s=new rn(r);return new Lt(t.path,s)}isEqual(t){return this===t}}class Nr extends Z{constructor(t,e){super(t),this.yt=e}_toFieldTransform(t){const e=new sn(t.L,tn(t.L,this.yt));return new Lt(t.path,e)}isEqual(t){return this===t}}function me(n,t,e,r){const s=n.dt(1,t,e);ge("Data must be an object, but it was:",s,r);const i=[],o=N.empty();yt(r,(u,l)=>{const f=ye(t,u,e);l=b(l);const d=s.ct(f);if(l instanceof wt)i.push(f);else{const p=et(l,d);p!=null&&(i.push(f),o.set(f,p))}});const a=new Q(i);return new mn(o,a,s.fieldTransforms)}function pe(n,t,e,r,s,i){const o=n.dt(1,t,e),a=[Ht(t,r,e)],u=[s];if(i.length%2!=0)throw new c(h,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let p=0;p<i.length;p+=2)a.push(Ht(t,i[p])),u.push(i[p+1]);const l=[],f=N.empty();for(let p=a.length-1;p>=0;--p)if(!_n(l,a[p])){const S=a[p];let y=u[p];y=b(y);const L=o.ct(S);if(y instanceof wt)l.push(S);else{const R=et(y,L);R!=null&&(l.push(S),f.set(S,R))}}const d=new Q(l);return new mn(f,d,o.fieldTransforms)}function yn(n,t,e,r=!1){return et(e,n.dt(r?4:3,t))}function et(n,t){if(vn(n=b(n)))return ge("Unsupported field value:",t,n),wn(n,t);if(n instanceof Z)return function(e,r){if(!pn(r.rt))throw r.ht(`${e._methodName}() can only be used with update() and set()`);if(!r.path)throw r.ht(`${e._methodName}() is not currently supported inside arrays`);const s=e._toFieldTransform(r);s&&r.fieldTransforms.push(s)}(n,t),null;if(n===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),n instanceof Array){if(t.settings.ot&&t.rt!==4)throw t.ht("Nested arrays are not supported");return function(e,r){const s=[];let i=0;for(const o of e){let a=et(o,r.at(i));a==null&&(a={nullValue:"NULL_VALUE"}),s.push(a),i++}return{arrayValue:{values:s}}}(n,t)}return function(e,r){if((e=b(e))===null)return{nullValue:"NULL_VALUE"};if(typeof e=="number")return tn(r.L,e);if(typeof e=="boolean")return{booleanValue:e};if(typeof e=="string")return{stringValue:e};if(e instanceof Date){const s=x.fromDate(e);return{timestampValue:Gt(r.L,s)}}if(e instanceof x){const s=new x(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:Gt(r.L,s)}}if(e instanceof de)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof it)return{bytesValue:dr(r.L,e._byteString)};if(e instanceof E){const s=r.databaseId,i=e.firestore._databaseId;if(!i.isEqual(s))throw r.ht(`Document reference is for database ${i.projectId}/${i.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:ce(e.firestore._databaseId||r.databaseId,e._key.path)}}throw r.ht(`Unsupported field value: ${qt(e)}`)}(n,t)}function wn(n,t){const e={};return function(r){for(const s in r)if(Object.prototype.hasOwnProperty.call(r,s))return!1;return!0}(n)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):yt(n,(r,s)=>{const i=et(s,t.it(r));i!=null&&(e[r]=i)}),{mapValue:{fields:e}}}function vn(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof x||n instanceof de||n instanceof it||n instanceof E||n instanceof Z)}function ge(n,t,e){if(!vn(e)||!function(r){return typeof r=="object"&&r!==null&&(Object.getPrototypeOf(r)===Object.prototype||Object.getPrototypeOf(r)===null)}(e)){const r=qt(e);throw r==="an object"?t.ht(n+" a custom object"):t.ht(n+" "+r)}}function Ht(n,t,e){if((t=b(t))instanceof X)return t._internalPath;if(typeof t=="string")return ye(n,t);throw xt("Field path arguments must be of type string or ",n,!1,void 0,e)}const xr=new RegExp("[~\\*/\\[\\]]");function ye(n,t,e){if(t.search(xr)>=0)throw xt(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,e);try{return new X(...t.split("."))._internalPath}catch{throw xt(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,e)}}function xt(n,t,e,r,s){const i=r&&!r.isEmpty(),o=s!==void 0;let a=`Function ${t}() called with invalid data`;e&&(a+=" (via `toFirestore()`)"),a+=". ";let u="";return(i||o)&&(u+=" (found",i&&(u+=` in field ${r}`),o&&(u+=` in document ${s}`),u+=")"),new c(h,a+n+u)}function _n(n,t){return n.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ps(){return new wt("deleteField")}function gs(){return new fe("serverTimestamp")}function ys(...n){return new Dr("arrayUnion",n)}function ws(...n){return new Fr("arrayRemove",n)}function vs(n){return new Nr("increment",n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mr{constructor(t,e,r,s,i){this.asyncQueue=t,this.datastore=e,this.options=r,this.updateFunction=s,this.deferred=i,this.Rt=r.maxAttempts,this.Pt=new hn(this.asyncQueue,"transaction_retry")}run(){this.Rt-=1,this.Vt()}Vt(){this.Pt.J(async()=>{const t=new Or(this.datastore),e=this.Nt(t);e&&e.then(r=>{this.asyncQueue.enqueueAndForget(()=>t.commit().then(()=>{this.deferred.resolve(r)}).catch(s=>{this.$t(s)}))}).catch(r=>{this.$t(r)})})}Nt(t){try{const e=this.updateFunction(t);return!He(e)&&e.catch&&e.then?e:(this.deferred.reject(Error("Transaction callback must return a Promise")),null)}catch(e){return this.deferred.reject(e),null}}$t(t){this.Rt>0&&this.Dt(t)?(this.Rt-=1,this.asyncQueue.enqueueAndForget(()=>(this.Vt(),Promise.resolve()))):this.deferred.reject(t)}Dt(t){if(t.name==="FirebaseError"){const e=t.code;return e==="aborted"||e==="failed-precondition"||e==="already-exists"||!function(r){switch(r){default:return g();case Zt:case rt:case Ue:case je:case Ke:case Ge:case Et:return!1;case h:case te:case On:case Be:case $:case ee:case ze:case ne:case Cn:return!0}}(e)}return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $r{constructor(){this.xt=Promise.resolve(),this.Ft=[],this.St=!1,this.qt=[],this.Ot=null,this.kt=!1,this.Ct=!1,this.Lt=[],this.Pt=new hn(this,"async_queue_retry"),this.Mt=()=>{const e=zt();e&&G("AsyncQueue","Visibility state changed to "+e.visibilityState),this.Pt.Z()};const t=zt();t&&typeof t.addEventListener=="function"&&t.addEventListener("visibilitychange",this.Mt)}get isShuttingDown(){return this.St}enqueueAndForget(t){this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this.Ut(),this.jt(t)}enterRestrictedMode(t){if(!this.St){this.St=!0,this.Ct=t||!1;const e=zt();e&&typeof e.removeEventListener=="function"&&e.removeEventListener("visibilitychange",this.Mt)}}enqueue(t){if(this.Ut(),this.St)return new Promise(()=>{});const e=new re;return this.jt(()=>this.St&&this.Ct?Promise.resolve():(t().then(e.resolve,e.reject),e.promise)).then(()=>e.promise)}enqueueRetryable(t){this.enqueueAndForget(()=>(this.Ft.push(t),this.Bt()))}async Bt(){if(this.Ft.length!==0){try{await this.Ft[0](),this.Ft.shift(),this.Pt.reset()}catch(t){if(!function(e){return e.name==="IndexedDbTransactionError"}(t))throw t;G("AsyncQueue","Operation failed with retryable error: "+t)}this.Ft.length>0&&this.Pt.J(()=>this.Bt())}}jt(t){const e=this.xt.then(()=>(this.kt=!0,t().catch(r=>{this.Ot=r,this.kt=!1;const s=function(i){let o=i.message||"";return i.stack&&(o=i.stack.includes(i.message)?i.stack:i.message+`
`+i.stack),o}(r);throw Rt("INTERNAL UNHANDLED ERROR: ",s),r}).then(r=>(this.kt=!1,r))));return this.xt=e,e}enqueueAfterDelay(t,e,r){this.Ut(),this.Lt.indexOf(t)>-1&&(e=0);const s=ve.createAndSchedule(this,t,e,r,i=>this.Qt(i));return this.qt.push(s),s}Ut(){this.Ot&&g()}verifyOperationInProgress(){}async zt(){let t;do t=this.xt,await t;while(t!==this.xt)}Gt(t){for(const e of this.qt)if(e.timerId===t)return!0;return!1}Wt(t){return this.zt().then(()=>{this.qt.sort((e,r)=>e.targetTimeMs-r.targetTimeMs);for(const e of this.qt)if(e.skipDelay(),t!=="all"&&e.timerId===t)break;return this.zt()})}Kt(t){this.Lt.push(t)}Qt(t){const e=this.qt.indexOf(t);this.qt.splice(e,1)}}class Ur{constructor(t,e){this._firestore=t,this._transaction=e,this._dataReader=tt(t)}get(t){const e=z(t,this._firestore),r=new Bt(this._firestore);return this._transaction.lookup([e._key]).then(s=>{if(!s||s.length!==1)return g();const i=s[0];if(i.isFoundDocument())return new Y(this._firestore,r,i.key,i,e.converter);if(i.isNoDocument())return new Y(this._firestore,r,e._key,null,e.converter);throw g()})}set(t,e,r){const s=z(t,this._firestore),i=Ut(s.converter,e,r),o=$t(this._dataReader,"Transaction.set",s._key,i,s.converter!==null,r);return this._transaction.set(s._key,o),this}update(t,e,r,...s){const i=z(t,this._firestore);let o;return o=typeof(e=b(e))=="string"||e instanceof X?pe(this._dataReader,"Transaction.update",i._key,e,r,s):me(this._dataReader,"Transaction.update",i._key,e),this._transaction.update(i._key,o),this}delete(t){const e=z(t,this._firestore);return this._transaction.delete(e._key),this}}function bs(n,t,e){const r=B(n=P(n,j)),s=Object.assign(Object.assign({},Cr),e);(function(o){if(o.maxAttempts<1)throw new c(h,"Max attempts must be at least 1")})(s);const i=new re;return new Mr(new $r,r,s,o=>t(new Ur(n,o)),i).run(),i.promise}(function(n){ot=n})(`${Ln}_lite`),qn(new Pn("firestore/lite",(n,{instanceIdentifier:t,options:e})=>{const r=n.getProvider("app").getImmediate(),s=new j(new Un(n.getProvider("auth-internal")),new Kn(n.getProvider("app-check-internal")),function(i,o){if(!Object.prototype.hasOwnProperty.apply(i.options,["projectId"]))throw new c(h,'"projectId" not provided in firebase.initializeApp.');return new dt(i.options.projectId,o)}(r,t),r);return e&&s._setSettings(e),s},"PUBLIC").setMultipleInstances(!0)),be("firestore-lite","3.7.3",""),be("firestore-lite","3.7.3","esm2017");export{Qr as AggregateField,Er as AggregateQuerySnapshot,it as Bytes,O as CollectionReference,E as DocumentReference,Y as DocumentSnapshot,X as FieldPath,Z as FieldValue,j as Firestore,c as FirestoreError,de as GeoPoint,q as Query,vt as QueryConstraint,bn as QueryDocumentSnapshot,Yt as QuerySnapshot,x as Timestamp,Ur as Transaction,Lr as WriteBatch,ds as addDoc,ms as aggregateQuerySnapshotEqual,ws as arrayRemove,ys as arrayUnion,Wr as collection,Hr as collectionGroup,Tr as connectFirestoreEmulator,hs as deleteDoc,ps as deleteField,kr as doc,Jr as documentId,os as endAt,is as endBefore,fs as getCount,as as getDoc,us as getDocs,Kr as getFirestore,vs as increment,zr as initializeFirestore,es as limit,ns as limitToLast,ts as orderBy,Xr as query,fn as queryEqual,Yr as refEqual,bs as runTransaction,gs as serverTimestamp,ls as setDoc,jr as setLogLevel,Rr as snapshotEqual,ss as startAfter,rs as startAt,Gr as terminate,cs as updateDoc,Zr as where,_s as writeBatch};
