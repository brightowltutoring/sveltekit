import{S as $,i as G,s as H,k as E,a as V,a8 as q,l as N,m as T,h as f,c as B,a0 as J,n as F,H as k,b as w,f as _,B as U,o as K,q as S,r as P,u as j,K as Y,L as X}from"../../../chunks/index-1bc46820.js";import{PUBLIC_STRIPE_KEY as z}from"../../../chunks/public-e0b14f20.js";import{e as W,f as Q}from"../../../chunks/index-66fab335.js";import{_ as Z,C as ee,r as b,b as te,g as C,c as ne,d as re,F as ie,e as se}from"../../../chunks/firebase-cb9dba95.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function we(e=re(),t=A){const i=te(C(e),I).getImmediate({identifier:t}),o=ne("functions");return o&&ye(i,...o),i}function ye(e,t,n){pe(C(e),t,n)}function Ae(e,t,n){return he(C(e),t,n)}ke(fetch.bind(self));function R(e){let t,n,i,o;return{c(){t=E("div"),n=S("Almost there "),i=S(e[3]),this.h()},l(r){t=N(r,"DIV",{class:!0});var s=T(t);n=P(s,"Almost there "),i=P(s,e[3]),s.forEach(f),this.h()},h(){F(t,"class","font-Poppins text-5xl text-center pt-20 animate-bounce loading svelte-tci3t6")},m(r,s){w(r,t,s),k(t,n),k(t,i)},p(r,s){e=r,s&8&&j(i,e[3])},i(r){o||Y(()=>{o=X(t,Q,{y:-400,duration:2e3,easing:W}),o.start()})},o:U,d(r){r&&f(t)}}}function Ce(e){let t,n,i,o,r=e[0]&&e[1]&&e[2]&&R(e);return{c(){t=E("script"),i=V(),o=E("main"),r&&r.c(),this.h()},l(s){const a=q("svelte-1jxl9zf",document.head);t=N(a,"SCRIPT",{src:!0});var u=T(t);u.forEach(f),a.forEach(f),i=B(s),o=N(s,"MAIN",{});var c=T(o);r&&r.l(c),c.forEach(f),this.h()},h(){document.title="Stripe Checkout",J(t.src,n="https://js.stripe.com/v3/")||F(t,"src",n)},m(s,a){k(document.head,t),w(s,i,a),w(s,o,a),r&&r.m(o,null)},p(s,[a]){s[0]&&s[1]&&s[2]?r?(r.p(s,a),a&7&&_(r,1)):(r=R(s),r.c(),_(r,1),r.m(o,null)):r&&(r.d(1),r=null)},i(s){_(r)},o:U,d(s){f(t),s&&f(i),s&&f(o),r&&r.d()}}}function Ie(e,t,n){let i,o=!1,r,s,a,u,c;const h=we(se);return K(async()=>{n(0,o=!0),r=window.location.search.slice(1),window.history.replaceState({},"",`/${btoa(r)}`),d();async function d(){try{const l=new URLSearchParams(r),v=l.get("invitee_full_name").split(" ")[0].toLowerCase();n(3,i=v.charAt(0).toUpperCase()+v.slice(1)),c=l.get("invitee_email"),n(2,u=l.get("answer_1").match(/\d+(\.\d{1,2})/)[0]*60),l.get("answer_2")&&(a=!0);for(let m of["classico","mock"])if(l.get("event_type_name").toLowerCase().includes(m)){n(1,s=m);break}if(s&&u){const m=Ae(h,"stripeSessionIdGCF"),{data:x}=await m({email:c,extra:a,service:s,quantity:u});Stripe(z).redirectToCheckout({sessionId:x.id})}}catch(l){console.log("stripeRedirectToCheckout failed",l)}}}),n(3,i=""),[o,s,u,i]}class Oe extends ${constructor(t){super(),G(this,t,Ie,Ce,H,{})}}export{Oe as default};
