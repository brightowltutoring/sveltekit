import{PUBLIC_FIREBASE_apiKey as di,PUBLIC_FIREBASE_authDomain as li,PUBLIC_FIREBASE_projectId as hi,PUBLIC_FIREBASE_storageBucket as fi,PUBLIC_FIREBASE_messagingSenderId as pi,PUBLIC_FIREBASE_appId as mi}from"./public-520e6fd8.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function I(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Ii(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(I())}function vi(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Ei(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function yi(){const n=I();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Ti(){try{return typeof indexedDB=="object"}catch{return!1}}function bi(){return new Promise((n,e)=>{try{let t=!0;const i="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(i);r.onsuccess=()=>{r.result.close(),t||self.indexedDB.deleteDatabase(i),n(!0)},r.onupgradeneeded=()=>{t=!1},r.onerror=()=>{var s;e(((s=r.error)===null||s===void 0?void 0:s.message)||"")}}catch(t){e(t)}})}function wi(){if(typeof self<"u")return self;if(typeof window<"u")return window;if(typeof global<"u")return global;throw new Error("Unable to locate global object.")}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nr{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(ir(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function ir(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const st="@firebase/app",xt="0.9.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const q=new ln("@firebase/app"),rr="@firebase/app-compat",sr="@firebase/analytics-compat",or="@firebase/analytics",ar="@firebase/app-check-compat",cr="@firebase/app-check",ur="@firebase/auth",dr="@firebase/auth-compat",lr="@firebase/database",hr="@firebase/database-compat",fr="@firebase/functions",pr="@firebase/functions-compat",mr="@firebase/installations",gr="@firebase/installations-compat",_r="@firebase/messaging",Ir="@firebase/messaging-compat",vr="@firebase/performance",Er="@firebase/performance-compat",yr="@firebase/remote-config",Tr="@firebase/remote-config-compat",br="@firebase/storage",wr="@firebase/storage-compat",Ar="@firebase/firestore",Sr="@firebase/firestore-compat",Rr="firebase",kr="9.15.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lr="firebase-heartbeat-database",Mr=1,ue="firebase-heartbeat-store";let Qe=null;function mn(){return Qe||(Qe=Zi(Lr,Mr,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(ue)}}}).catch(n=>{throw B.create("idb-open",{originalErrorMessage:n.message})})),Qe}async function Ur(n){try{return(await mn()).transaction(ue).objectStore(ue).get(gn(n))}catch(e){if(e instanceof H)q.warn(e.message);else{const t=B.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});q.warn(t.message)}}}async function Vt(n,e){try{const i=(await mn()).transaction(ue,"readwrite");return await i.objectStore(ue).put(e,gn(n)),i.done}catch(t){if(t instanceof H)q.warn(t.message);else{const i=B.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});q.warn(i.message)}}}function gn(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wr(n){ce(new ee("platform-logger",e=>new nr(e),"PRIVATE")),ce(new ee("heartbeat",e=>new Vr(e),"PRIVATE")),Y(st,xt,n),Y(st,xt,"esm2017"),Y("fire-js","")}Wr("");var $r="firebase",jr="9.15.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function En(n,e){const t=lt(n,"auth");if(t.isInitialized()){const r=t.getImmediate(),s=t.getOptions();if(Re(s,e??{}))return r;y(r,"already-initialized")}return t.initialize({options:e})}function Gr(n,e){const t=(e==null?void 0:e.persistence)||[],i=(Array.isArray(t)?t:[t]).map(S);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(n){var e,t;if(!n)return null;const{providerId:i}=n,r=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},s=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!i&&(n!=null&&n.idToken)){const o=(t=(e=Le(n.idToken))===null||e===void 0?void 0:e.firebase)===null||t===void 0?void 0:t.sign_in_provider;if(o){const a=o!=="anonymous"&&o!=="custom"?o:null;return new Q(s,a)}}if(!i)return null;switch(i){case"facebook.com":return new $s(s,r);case"github.com":return new js(s,r);case"google.com":return new zs(s,r);case"twitter.com":return new qs(s,r,n.screenName||null);case"custom":case"anonymous":return new Q(s,null);default:return new Q(s,i,r)}}class Q{constructor(e,t,i={}){this.isNewUser=e,this.providerId=t,this.profile=i}}class $n extends Q{constructor(e,t,i,r){super(e,t,i),this.username=r}}class $s extends Q{constructor(e,t){super(e,"facebook.com",t)}}class js extends $n{constructor(e,t){super(e,"github.com",t,typeof(t==null?void 0:t.login)=="string"?t==null?void 0:t.login:null)}}class zs extends Q{constructor(e,t){super(e,"google.com",t)}}class qs extends $n{constructor(e,t,i){super(e,"twitter.com",t,i)}}function ic(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:Ws(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
