import{S as yi,i as vi,s as br,k,a as F,q as Re,l as A,m as $,c as V,r as Oe,h as P,n as v,p as ze,b as Er,L as g,F as Ke,t as Nn,d as Ii,f as Pn,C as Tr,E as jt,o as wi,$ as Ln,D as bi,G as Ei,H as Ti,A as Sr,g as Si,I as ft}from"../../../chunks/index-63f99ff6.js";import{r as Mn,a as Un,d as Ht}from"../../../chunks/store-afad959b.js";import{e as ki,s as Ai}from"../../../chunks/index-4caf361a.js";import{g as Fn}from"../../../chunks/navigation-bdde6290.js";import"../../../chunks/index-0ab04b87.js";import"../../../chunks/singletons-ce96ddbc.js";const Ri="AIzaSyDSux33iJAZsssEo2Za7As_eGGEThwXQZo",Oi="thinksolve-app.firebaseapp.com",Di="thinksolve-app",Ci="thinksolve-app.appspot.com",Ni="490986955869",Pi="1:490986955869:web:433c6f7b31865fed5099b4";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gs{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(_s(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function _s(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const en="@firebase/app",jn="0.7.31";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function no(n){Me(new be("platform-logger",e=>new gs(e),"PRIVATE")),Me(new be("heartbeat",e=>new Zs(e),"PRIVATE")),_e(en,jn,n),_e(en,jn,"esm2017"),_e("fire-js","")}no("");var ro="firebase",io="9.9.3";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qr(n,e,t=!1){const r="signIn",i=await Xr(n,r,e),s=await Ue._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}async function jo(n,e){return Qr(Ct(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wo(n,e,t){const r=oe(n),i={requestType:"EMAIL_SIGNIN",email:e};u(t.handleCodeInApp,r,"argument-error"),t&&Ho(r,i,t),await Lo(r,i)}function zo(n,e){const t=Nt.parseLink(e);return(t==null?void 0:t.operation)==="EMAIL_SIGNIN"}async function qo(n,e,t){const r=oe(n),i=$e.credentialWithLink(e,t||bt());return u(i._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),jo(r,i)}function Go(n,e,t,r){return oe(n).onAuthStateChanged(e,t,r)}function Ko(n){return oe(n).signOut()}const St="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fa=new lt(5e3,15e3),Va="__/auth/iframe",Ba="emulator/auth/iframe",xa={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},$a=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function ja(n){const e=n.config;u(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?pn(e,Ba):`https://${n.config.authDomain}/${Va}`,r={apiKey:e.apiKey,appName:n.name,v:ct},i=$a.get(n.config.apiHost);i&&(r.eid=i);const s=n._getFrameworks();return s.length&&(r.fw=s.join(",")),`${t}?${at(r).slice(1)}`}async function Ha(n){const e=await Ua(n),t=G().gapi;return u(t,n,"internal-error"),e.open({where:document.body,url:ja(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:xa,dontclear:!0},r=>new Promise(async(i,s)=>{await r.restyle({setHideOnLeave:!1});const o=q(n,"network-request-failed"),a=G().setTimeout(()=>{s(o)},Fa.get());function c(){G().clearTimeout(a),i(r)}r.ping(c).then(c,()=>{s(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yt="webStorageSupport";class ec{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=ni,this._completeRedirectFn=Sa,this._overrideRedirectResult=ba}async _openPopup(e,t,r,i){var s;ne((s=this.eventManagers[e._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const o=ir(e,t,r,bt(),i);return Ja(e,o,vn())}async _openRedirect(e,t,r,i){return await this._originValidation(e),ta(ir(e,t,r,bt(),i)),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:s}=this.eventManagers[t];return i?Promise.resolve(i):(ne(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await Ha(e),r=new Aa(e);return t.register("authEvent",i=>(u(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Yt,{type:Yt},i=>{var s;const o=(s=i==null?void 0:i[0])===null||s===void 0?void 0:s[Yt];o!==void 0&&t(!!o),x(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Na(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Jr()||gn()||Dt()}}const tc=ec;var sr="@firebase/auth",or="0.20.5";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fe=new ln("@firebase/firestore");function At(n,...e){if(Fe.logLevel<=_.DEBUG){const t=e.map(bn);Fe.debug(`Firestore (${je}): ${n}`,...t)}}function wn(n,...e){if(Fe.logLevel<=_.ERROR){const t=e.map(bn);Fe.error(`Firestore (${je}): ${n}`,...t)}}function oc(n,...e){if(Fe.logLevel<=_.WARN){const t=e.map(bn);Fe.warn(`Firestore (${je}): ${n}`,...t)}}function bn(n){if(typeof n=="string")return n;try{return e=n,JSON.stringify(e)}catch{return n}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ke(n="Unexpected state"){const e=`FIRESTORE (${je}) INTERNAL ASSERTION FAILED: `+n;throw wn(e),new Error(e)}function re(n,e){n||ke()}function En(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(m=ur||(ur={}))[m.OK=0]="OK",m[m.CANCELLED=1]="CANCELLED",m[m.UNKNOWN=2]="UNKNOWN",m[m.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",m[m.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",m[m.NOT_FOUND=5]="NOT_FOUND",m[m.ALREADY_EXISTS=6]="ALREADY_EXISTS",m[m.PERMISSION_DENIED=7]="PERMISSION_DENIED",m[m.UNAUTHENTICATED=16]="UNAUTHENTICATED",m[m.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",m[m.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",m[m.ABORTED=10]="ABORTED",m[m.OUT_OF_RANGE=11]="OUT_OF_RANGE",m[m.UNIMPLEMENTED=12]="UNIMPLEMENTED",m[m.INTERNAL=13]="INTERNAL",m[m.UNAVAILABLE=14]="UNAVAILABLE",m[m.DATA_LOSS=15]="DATA_LOSS";class Dc extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http";this.h=t+"://"+e.host,this.l="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}m(e,t,r,i,s){const o=this.p(e,t);At("RestConnection","Sending: ",o,r);const a={};return this.g(a,i,s),this.v(e,o,a,r).then(c=>(At("RestConnection","Received: ",c),c),c=>{throw oc("RestConnection",`${e} failed with error: `,c,"url: ",o,"request:",r),c})}T(e,t,r,i,s,o){return this.m(e,t,r,i,s)}g(e,t,r){e["X-Goog-Api-Client"]="gl-js/ fire/"+je,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((i,s)=>e[s]=i),r&&r.headers.forEach((i,s)=>e[s]=i)}p(e,t){const r=Oc[e];return`${this.h}/v1/${t}:${r}`}}{constructor(e,t){super(e),this.I=t}A(e,t){throw new Error("Not supported by FetchConnection")}async v(e,t,r,i){const s=JSON.stringify(i);let o;try{o=await this.I(t,{method:"POST",headers:r,body:s})}catch(a){throw new p(dr(a.status),"Request failed with error: "+a.statusText)}if(!o.ok)throw new p(dr(o.status),"Request failed with error: "+o.statusText);return o.json()}}function it(n,e){return n<e?-1:n>e?1:0}function Cc(n,e,t){return n.length===e.length&&n.every((r,i)=>t(r,e[i]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class he{constructor(e,t,r,i,s,o){this.key=e,this.documentType=t,this.version=r,this.readTime=i,this.data=s,this.documentState=o}static newInvalidDocument(e){return new he(e,0,j.min(),j.min(),X.empty(),0)}static newFoundDocument(e,t,r){return new he(e,1,t,j.min(),r,0)}static newNoDocument(e,t){return new he(e,2,t,j.min(),X.empty(),0)}static newUnknownDocument(e,t){return new he(e,3,t,j.min(),X.empty(),2)}convertToFoundDocument(e,t){return this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=X.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=X.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=j.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof he&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new he(this.key,this.documentType,this.version,this.readTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Le(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new He(this.firestore,e,this._key)}}class Mt{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Mt(this.firestore,e,this._query)}}class Le extends Mt{constructor(e,t,r){super(e,t,new Lc(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new He(this.firestore,null,new ee(e))}withConverter(e){return new Le(this.firestore,e,this._path)}}function Qc(n,e,...t){if(n=oe(n),Sc("collection","path",e),n instanceof pi){const r=O.fromString(e,...t);return cr(r),new Le(n,null,r)}{if(!(n instanceof He||n instanceof Le))throw new p(y,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(O.fromString(e,...t));return cr(r),new Le(n.firestore,null,r)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
