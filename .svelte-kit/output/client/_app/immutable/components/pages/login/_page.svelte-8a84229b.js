import{S as wi,i as bi,s as Sr,k as E,a as P,q as Ce,l as T,m as B,h as C,c as L,r as Ne,n as I,$ as Ei,p as k,b as Ar,F as m,G as Je,t as Mn,d as Ti,f as Un,C as kr,E as zt,o as Si,a3 as Fn,D as Ai,I as ki,J as Ri,A as Rr,g as Oi,K as pt}from"../../../chunks/index-00687be8.js";import{r as Vn,b as Bn,e as qt}from"../../../chunks/store-686bfb8b.js";import{a as Di}from"../../../chunks/index-3fc8dc6f.js";import{e as Ci}from"../../../chunks/index-c7021fa9.js";import{g as xn}from"../../../chunks/navigation-545cd73f.js";import"../../../chunks/index-847890c3.js";import"../../../chunks/singletons-6712cf78.js";const Ni="AIzaSyDSux33iJAZsssEo2Za7As_eGGEThwXQZo",Pi="thinksolve-app.firebaseapp.com",Li="thinksolve-app",Mi="thinksolve-app.appspot.com",Ui="490986955869",Fi="1:490986955869:web:433c6f7b31865fed5099b4";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Se=new hn("@firebase/app"),bs="@firebase/app-compat",Es="@firebase/analytics-compat",Ts="@firebase/analytics",Ss="@firebase/app-check-compat",As="@firebase/app-check",ks="@firebase/auth",Rs="@firebase/auth-compat",Os="@firebase/database",Ds="@firebase/database-compat",Cs="@firebase/functions",Ns="@firebase/functions-compat",Ps="@firebase/installations",Ls="@firebase/installations-compat",Ms="@firebase/messaging",Us="@firebase/messaging-compat",Fs="@firebase/performance",Vs="@firebase/performance-compat",Bs="@firebase/remote-config",xs="@firebase/remote-config-compat",$s="@firebase/storage",Hs="@firebase/storage-compat",js="@firebase/firestore",Ws="@firebase/firestore-compat",zs="firebase",qs="9.9.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lr="[DEFAULT]",Gs={[rn]:"fire-core",[bs]:"fire-core-compat",[Ts]:"fire-analytics",[Es]:"fire-analytics-compat",[As]:"fire-app-check",[Ss]:"fire-app-check-compat",[ks]:"fire-auth",[Rs]:"fire-auth-compat",[Os]:"fire-rtdb",[Ds]:"fire-rtdb-compat",[Cs]:"fire-fn",[Ns]:"fire-fn-compat",[Ps]:"fire-iid",[Ls]:"fire-iid-compat",[Ms]:"fire-fcm",[Us]:"fire-fcm-compat",[Fs]:"fire-perf",[Vs]:"fire-perf-compat",[Bs]:"fire-rc",[xs]:"fire-rc-compat",[$s]:"fire-gcs",[Hs]:"fire-gcs-compat",[js]:"fire-fst",[Ws]:"fire-fst-compat","fire-js":"fire-js",[zs]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lt=qs;function Xs(n,e={}){typeof e!="object"&&(e={name:e});const t=Object.assign({name:Lr,automaticDataCollectionEnabled:!1},e),r=t.name;if(typeof r!="string"||!r)throw Ae.create("bad-app-name",{appName:String(r)});const i=bt.get(r);if(i){if(wt(n,i.options)&&wt(t,i.config))return i;throw Ae.create("duplicate-app",{appName:r})}const s=new is(r);for(const a of sn.values())s.addComponent(a);const o=new Ys(n,t,s);return bt.set(r,o),o}function Mr(n=Lr){const e=bt.get(n);if(!e)throw Ae.create("no-app",{appName:n});return e}function ve(n,e,t){var r;let i=(r=Gs[n])!==null&&r!==void 0?r:n;t&&(i+=`-${t}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Se.warn(a.join(" "));return}Ve(new Te(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tt(n){var e;const t=n.auth,r=await n.getIdToken(),i=await tt(n,wo(t,{idToken:r}));u(i==null?void 0:i.users.length,t,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const o=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?Ro(s.providerUserInfo):[],a=ko(n.providerData,o),c=n.isAnonymous,l=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),d=c?l:!1,h={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new Wr(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,h)}async function Ao(n){const e=oe(n);await Tt(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function ko(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function Ro(n){return n.map(e=>{var{providerId:t}=e,r=mn(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Uo(n,e){return Dt(n,"POST","/v1/accounts:signInWithPassword",dt(n,e))}async function Fo(n,e){return je(n,"POST","/v1/accounts:sendOobCode",dt(n,e))}async function Vo(n,e){return Fo(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Re(n="Unexpected state"){const e=`FIRESTORE (${ze}) INTERNAL ASSERTION FAILED: `+n;throw Tn(e),new Error(e)}function re(n,e){n||Re()}function An(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ic{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class wc{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(x.UNAUTHENTICATED))}shutdown(){}}class bc{constructor(e){this.auth=null,e.onInit(t=>{this.auth=t})}getToken(){return this.auth?this.auth.getToken().then(e=>e?(re(typeof e.accessToken=="string"),new Ic(e.accessToken,new x(this.auth.getUid()))):null):Promise.resolve(null)}invalidateToken(){}start(e,t){}shutdown(){}}class Ec{constructor(e,t,r){this.type="FirstParty",this.user=x.FIRST_PARTY,this.headers=new Map,this.headers.set("X-Goog-AuthUser",t);const i=e.auth.getAuthHeaderValueForFirstParty([]);i&&this.headers.set("Authorization",i),r&&this.headers.set("X-Goog-Iam-Authorization-Token",r)}}class Tc{constructor(e,t,r){this.t=e,this.i=t,this.o=r}getToken(){return Promise.resolve(new Ec(this.t,this.i,this.o))}start(e,t){e.enqueueRetryable(()=>t(x.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Sc{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Ac{constructor(e){this.u=e,this.appCheck=null,e.onInit(t=>{this.appCheck=t})}getToken(){return this.appCheck?this.appCheck.getToken().then(e=>e?(re(typeof e.token=="string"),new Sc(e.token)):null):Promise.resolve(null)}invalidateToken(){}start(e,t){}shutdown(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mr(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function kn(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ze=new Map;function el(n){if(n._terminated)throw new p($e,"The client has already been terminated.");if(!Ze.has(n)){Rt("ComponentProvider","Initializing Datastore");const s=function(c){return new Lc(c,fetch.bind(null))}((e=n._databaseId,t=n.app.options.appId||"",r=n._persistenceKey,i=n._freezeSettings(),new kc(e,t,r,i.host,i.ssl,i.experimentalForceLongPolling,i.experimentalAutoDetectLongPolling,i.useFetchStreams))),o=Xc(n._databaseId),a=function(c,l,d,h){return new Qc(c,l,d,h)}(n._authCredentials,n._appCheckCredentials,s,o);Ze.set(n,a)}var e,t,r,i;/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ol{constructor(e,t,r,i,s){this._firestore=e,this._userDataWriter=t,this._key=r,this._document=i,this._converter=s}get id(){return this._key.path.lastSegment()}get ref(){return new qe(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new yi(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(cl("DocumentSnapshot.get",e));if(t!==null)return this._userDataWriter.convertValue(t)}}}class yi extends ol{data(){return super.data()}}class al{constructor(e,t){this._docs=t,this.query=e}get docs(){return[...this._docs]}get size(){return this.docs.length}get empty(){return this.docs.length===0}forEach(e,t){this._docs.forEach(e,t)}}function cl(n,e){return typeof e=="string"?sl(n,e):e instanceof vi?e._internalPath:e._delegate._internalPath}class ll extends class{convertValue(e,t="none"){switch(un(e)){case 0:return null;case 1:return e.booleanValue;case 2:return M(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(cn(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 10:return this.convertObject(e.mapValue,t);default:throw Re()}}convertObject(e,t){const r={};return kn(e.fields,(i,s)=>{r[i]=this.convertValue(s,t)}),r}convertGeoPoint(e){return new rl(M(e.latitude),M(e.longitude))}convertArray(e,t){return(e.values||[]).map(r=>this.convertValue(r,t))}convertServerTimestamp(e,t){switch(t){case"previous":const r=mi(e);return r==null?null:this.convertValue(r,t);case"estimate":return this.convertTimestamp(ln(e));default:return null}}convertTimestamp(e){const t=ot(e);return new te(t.seconds,t.nanos)}convertDocumentKey(e,t){const r=O.fromString(e);re(gi(r));const i=new He(r.get(1),r.get(3)),s=new ee(r.popFirst(5));return i.isEqual(t)||Tn(`Document ${s} contains a document reference within a different database (${i.projectId}/${i.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),s}}{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ot(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new qe(this.firestore,null,t)}}function ul(n){(function(r){if(r.limitType==="L"&&r.explicitOrderBy.length===0)throw new p(fi,"limitToLast() queries require specifying at least one orderBy() clause")})((n=Cc(n,Ut))._query);const e=el(n.firestore),t=new ll(n.firestore);return Zc(e,n._query).then(r=>{const i=r.map(s=>new yi(n.firestore,t,s.key,s,n.converter));return n._query.limitType==="L"&&i.reverse(),new al(n,i)})}(function(n){ze=n})(`${lt}_lite`),Ve(new Te("firestore/lite",(n,{options:e})=>{const t=n.getProvider("app").getImmediate(),r=new _i(t,new bc(n.getProvider("auth-internal")),new Ac(n.getProvider("app-check-internal")));return e&&r._setSettings(e),r},"PUBLIC")),ve("firestore-lite","3.4.14",""),ve("firestore-lite","3.4.14","esm2017");const dl={apiKey:Ni,authDomain:Pi,projectId:Li,storageBucket:Mi,messagingSenderId:Ui,appId:Fi},Ii=Xs(dl),Le=lc(Ii),hl=tl(Ii);function Tr(n){let e,t,r,i;return{c(){e=E("input"),this.h()},l(s){e=T(s,"INPUT",{id:!0,type:!0,placeholder:!0,class:!0}),this.h()},h(){I(e,"id","emailField"),I(e,"type","email"),I(e,"placeholder","email"),I(e,"class","svelte-m7g9u3")},m(s,o){Ar(s,e,o),Fn(e,n[0]),r||(i=[Je(e,"input",n[6]),Je(e,"input",function(){Ai(n[2](n[0]))&&n[2](n[0]).apply(this,arguments)})],r=!0)},p(s,o){n=s,o&1&&e.value!==n[0]&&Fn(e,n[0])},i(s){s&&(t||ki(()=>{t=Ri(e,Di,{duration:500,easing:Ci}),t.start()}))},o:Rr,d(s){s&&C(e),r=!1,kr(i)}}}function fl(n){let e,t,r,i,s,o,a,c,l,d,h,w,S,U,ae,f,v,N,q,ce=n[1],H,D,Oe,Y,ye,A,Ie,Ft,Vt,De,Bt,xt,le,$t,Ht,ue,jt,Wt,Rn,F=Tr(n);return{c(){e=E("main"),t=E("video"),i=P(),s=E("div"),o=E("br"),a=P(),c=E("br"),l=P(),d=E("button"),h=Ce("Sign-in with Google"),w=P(),S=E("br"),U=P(),ae=E("br"),f=P(),v=E("button"),N=Ce("Sign-in via link"),q=P(),F.c(),H=P(),D=E("span"),Oe=P(),Y=E("span"),ye=P(),A=E("div"),Ie=E("h2"),Ft=Ce("Welcome User"),Vt=P(),De=E("h3"),Bt=Ce("Redirecting to your page in"),xt=P(),le=E("h3"),$t=Ce("\u230A\u03C0\u230B"),Ht=P(),ue=E("button"),jt=Ce("Logout"),this.h()},l(V){e=T(V,"MAIN",{});var j=B(e);t=T(j,"VIDEO",{controlslist:!0,src:!0,style:!0}),B(t).forEach(C),i=L(j),s=T(j,"DIV",{class:!0,id:!0,style:!0});var b=B(s);o=T(b,"BR",{}),a=L(b),c=T(b,"BR",{}),l=L(b),d=T(b,"BUTTON",{id:!0,class:!0});var On=B(d);h=Ne(On,"Sign-in with Google"),On.forEach(C),w=L(b),S=T(b,"BR",{}),U=L(b),ae=T(b,"BR",{}),f=L(b),v=T(b,"BUTTON",{id:!0,class:!0});var Dn=B(v);N=Ne(Dn,"Sign-in via link"),Dn.forEach(C),q=L(b),F.l(b),H=L(b),D=T(b,"SPAN",{id:!0,class:!0,style:!0}),B(D).forEach(C),Oe=L(b),Y=T(b,"SPAN",{id:!0,style:!0,class:!0}),B(Y).forEach(C),b.forEach(C),ye=L(j),A=T(j,"DIV",{class:!0,id:!0,style:!0});var de=B(A);Ie=T(de,"H2",{class:!0,id:!0});var Cn=B(Ie);Ft=Ne(Cn,"Welcome User"),Cn.forEach(C),Vt=L(de),De=T(de,"H3",{class:!0});var Nn=B(De);Bt=Ne(Nn,"Redirecting to your page in"),Nn.forEach(C),xt=L(de),le=T(de,"H3",{class:!0,style:!0,id:!0});var Pn=B(le);$t=Ne(Pn,"\u230A\u03C0\u230B"),Pn.forEach(C),Ht=L(de),ue=T(de,"BUTTON",{id:!0,class:!0});var Ln=B(ue);jt=Ne(Ln,"Logout"),Ln.forEach(C),de.forEach(C),j.forEach(C),this.h()},h(){t.autoplay=!0,t.loop=!0,t.muted=!0,t.playsInline=!0,I(t,"controlslist","nodownload"),Ei(t.src,r="/login-bg-video-blurred.mp4")||I(t,"src",r),k(t,"min-height","90vh"),k(t,"max-height","90vh"),k(t,"min-width","100vw"),k(t,"max-width","100vw"),k(t,"position","absolute"),k(t,"z-index","-1"),k(t,"top","0"),k(t,"left","0"),k(t,"margin","0"),k(t,"padding","0"),k(t,"filter","blur(10px)"),I(d,"id","googleBtn"),I(d,"class","svelte-m7g9u3"),I(v,"id","passwordlessLoginBtn"),I(v,"class","svelte-m7g9u3"),I(D,"id","emailStatusMessage"),I(D,"class","centering  svelte-m7g9u3"),k(D,"display","none"),I(Y,"id","flyingEmoji"),k(Y,"display","none"),I(Y,"class","svelte-m7g9u3"),I(s,"class","loginLogoutDivs  svelte-m7g9u3"),I(s,"id","logInDiv"),k(s,"display","block"),I(Ie,"class","centering svelte-m7g9u3"),I(Ie,"id","loginWelcomeText"),I(De,"class","centering svelte-m7g9u3"),I(le,"class","centering svelte-m7g9u3"),k(le,"font-size","30px"),I(le,"id","redirectMessage"),I(ue,"id","logoutBtn"),I(ue,"class","svelte-m7g9u3"),I(A,"class","loginLogoutDivs svelte-m7g9u3"),I(A,"id","logOutDiv"),k(A,"display","none")},m(V,j){Ar(V,e,j),m(e,t),m(e,i),m(e,s),m(s,o),m(s,a),m(s,c),m(s,l),m(s,d),m(d,h),m(s,w),m(s,S),m(s,U),m(s,ae),m(s,f),m(s,v),m(v,N),m(s,q),F.m(s,null),m(s,H),m(s,D),m(s,Oe),m(s,Y),m(e,ye),m(e,A),m(A,Ie),m(Ie,Ft),m(A,Vt),m(A,De),m(De,Bt),m(A,xt),m(A,le),m(le,$t),m(A,Ht),m(A,ue),m(ue,jt),Wt||(Rn=[Je(d,"click",n[3]),Je(v,"click",n[5]),Je(ue,"click",n[4])],Wt=!0)},p(V,[j]){j&2&&Sr(ce,ce=V[1])?(Oi(),Mn(F,1,1,Rr),Ti(),F=Tr(V),F.c(),Un(F,1),F.m(s,H)):F.p(V,j)},i(V){Un(F)},o(V){Mn(F)},d(V){V&&C(e),F.d(V),Wt=!1,kr(Rn)}}}function pl(n,e,t){let r,i,s;zt(n,Vn,f=>t(7,r=f)),zt(n,Bn,f=>t(8,i=f)),zt(n,qt,f=>t(9,s=f));let o="",a=!1;Si(()=>{if(Jo(Le,window.location.href)){let f=window.localStorage.getItem("emailForSignIn");f||(f=window.prompt("Please provide your email for confirmation")),Yo(Le,f,window.location.href).then(()=>window.localStorage.removeItem("emailForSignIn")).catch(v=>console.log(v))}Xo(Le,f=>{f?(pt(qt,s=!0,s),console.log("User is signed in!"),w(f.email),logInDiv.style.display="none",logOutDiv.style.display="block",loginWelcomeText.innerText=f.displayName?`Hey ${f.displayName}!`:`Hey ${f.email}!`):(pt(qt,s=!1,s),console.log("User is NOT signed in"))})});function c(f){const v=/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(f);f.length===0?(emailField.style.border="1px solid #aaa",emailField.style.color="#aaa",emailField.style.fontSize="16px"):v?(emailField.style.border="2px solid #59d0ae",emailField.style.backgroundColor="white",emailField.style.color="#10bb8a",passwordlessLoginBtn.addEventListener("click",()=>S()),emailField.addEventListener("keydown",N=>{N.key==="Enter"&&S()})):(emailField.style.border="1.5px solid red",emailField.style.color="red",emailField.style.fontSize="20px")}function l(){const f=new z;ba(Le,f).then(v=>{z.credentialFromResult(v).accessToken,v.user}).catch(v=>{v.code,v.message,v.customData.email,z.credentialFromError(v)})}function d(){let f=emailField.value;console.log(f),f.length!==0&&Ko(Le,f,{url:"https://thinksolve.io/login",handleCodeInApp:!0}).then(()=>{window.localStorage.setItem("emailForSignIn",f),console.log("success with sendSignInLinkToEmail!")}).catch(N=>{N.code,N.message,console.log("error with sendSignInLinkToEmail")})}function h(){Qo(Le).then(()=>{console.log("logged out"),xn("/")}).catch(f=>{console.log(f),console.log("FAILED firebase signOut function")})}async function w(f){const v=nl(hl,"email");(await ul(v)).forEach(q=>{if(f===q.id){let ce=3e3,H=parseInt(ce/1e3),D="/";console.log(`A match! ${q.id} => ${D}`),pt(Bn,i=setInterval(()=>{H>0&&(H+=-1,document.getElementById("redirectMessage").innerHTML=` ${H}`)},1e3),i),pt(Vn,r=setTimeout(()=>{xn(D)},ce),r)}})}function S(){passwordlessLoginBtn.style.opacity="0.2",passwordlessLoginBtn.style.pointerEvents="none",d(),window.addEventListener("keydown",f=>f.stopImmediatePropagation(),!0),window.addEventListener("click",f=>f.stopImmediatePropagation(),!0),flyingEmoji.style.display="block",emailStatusMessage.style.display="block",emailStatusMessage.innerHTML=`
                <span class="centering" style=" font-weight: bold; font-size: 18px; color: #10bb8a"> 
                    Link sent to email 
                </span>
                `}const U=()=>{o.length==0&&t(1,a=!a)};function ae(){o=this.value,t(0,o)}return[o,a,c,l,h,U,ae]}class bl extends wi{constructor(e){super(),bi(this,e,pl,fl,Sr,{})}}export{bl as default};
