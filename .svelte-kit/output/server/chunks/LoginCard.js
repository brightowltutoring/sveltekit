...
const LoginCard_svelte_svelte_type_style_lang = "";
const css = {
  code: ".card-styles.svelte-kjxzgo{position:relative;margin-left:auto;margin-right:auto;display:block;width:90vw;border-radius:1rem;padding-top:2.5rem;padding-bottom:2.5rem;padding-left:1.25rem;padding-right:1.25rem;font-family:Poppins, sans-serif;--tw-shadow:0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 4px 6px -1px var(--tw-shadow-color), 0 2px 4px -2px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);transition-duration:300ms\n}.card-styles.svelte-kjxzgo:hover{--tw-scale-x:1.01;--tw-scale-y:1.01;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));border-radius:1.5rem\n}@media(min-width: 640px){.card-styles.svelte-kjxzgo{width:500px;padding:2.5rem\n    }}",
  map: null
};
const LoginCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="${"w-screen flex justify-center items-center"}">${!$isLoggedIn ? `<login-card class="${"card-styles text-xl " + escape($isDarkMode ? "hover:shadow-xl " : "hover:shadow-lg", true) + " svelte-kjxzgo"}"${add_attribute("style", `background:${$elementColor}`, 0)}>${`${validate_component(MagicLinkSection, "MagicLinkSection").$$render($$result, {}, {}, {})}
  ...
  ${$isLoggedIn ? `<logout-card class="${"card-styles " + escape($isDarkMode ? "hover:shadow-xl" : "hover:shadow-lg", true) + " svelte-kjxzgo"}"${add_attribute("style", `background:${$elementColor} `, 0)}><p${add_attribute("this", loginWelcomeText, 0)}>Welcome User</p>
