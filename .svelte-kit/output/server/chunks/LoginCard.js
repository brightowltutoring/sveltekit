...
const IconTwitter = create_ssr_component(
...
const TwitterLoginButton = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    return `<signin-button class="${
      "group bg-[#1d9bf0] hover:shadow-md hover:scale-[1.01] duration-200 rounded-md p-4 " +
      escape(
        $isDarkMode ? "group-hover:bg-opacity-90" : "group-hover:bg-opacity-90",
        true
      ) +
      " text-white flex justify-center items-center gap-5"
    }"><span class="${"group-hover:scale-[1.15] duration-500"}">${validate_component(
      IconTwitter,
      "IconTwitter"
    ).$$render($$result, {}, {}, {})}</span>
...
const GoogleLoginButton = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $isDarkMode, $$unsubscribe_isDarkMode;
    $$unsubscribe_isDarkMode = subscribe(
      isDarkMode,
    ...
    $$unsubscribe_isDarkMode();
    return `<signin-button class="${
      "group mb-6 bg-[#4285f4] hover:shadow-md hover:scale-[1.01] duration-200 rounded-md p-4 " +
      escape(
        $isDarkMode ? "group-hover:bg-opacity-90" : "group-hover:bg-opacity-90",
        true
      ) +
...
const MagicLinkSection = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let shortPing;
    ...
    userInputVisible = browser;
    $$unsubscribe_isDarkMode();
    return `<signin-button class="${
      "group bg-emerald-500 hover:scale-[1.01] hover:shadow-md duration-200 rounded-md p-4 " +
      escape(
...
${
  userInputVisible
    ? `<input class="${
        "text-center p-3 mt-3 w-full " +
        escape(shortPing, true) +
        " focus:outline-none"
      }" type="${"email"}" placeholder="${"email"}"${add_attribute(
        "this",
        emailField,
        0
      )}${add_attribute("value", emailFieldValue, 0)}>`
    : ``
}
...
const IconPhone = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    return `
...
const PhoneAuthSection = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let shortPing;
    let userInputVisible;
    let $isDarkMode, $$unsubscribe_isDarkMode;
    ...
    return `
${`<div class="${
  "w-full group bg-rose-400 hover:scale-[1.01] hover:shadow-md duration-200 rounded-md p-4 " +
  escape(
    $isDarkMode ? "group-hover:bg-opacity-80" : "group-hover:bg-opacity-80",
    true
  ) +
  ...
  userInputVisible
    ? `<input class="${"col-span-1 text-center p-3 mt-3 focus:outline-none border-r-2"}"${add_attribute(
        "value",
        countryCode,
        0
      )}>
      <input class="${
        "col-span-5 text-center p-3 mt-3 focus:outline-none " +
        escape(shortPing, true)
      }" type="${"phone"}" placeholder="${"phone"}"${add_attribute(
        "this",
        phoneField,
        0
      )}${add_attribute("value", phoneFieldValue, 0)}>`
    : ``
}</div>`}

<div id="${"recaptcha-container"}"></div>
<div id="${"phoneStatusMessage"}" class="${
      "p-3 font-Poppins " +
      escape($isDarkMode ? "text-lime-100" : "text-rose-600", true)
    }"></div>
...
const LoginCard = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    if (
      $$props.noTransition === void 0 &&
      $$bindings.noTransition &&
      noTransition !== void 0
    )
    ...
    return `${
      !$isLoggedIn
        ? `<login-card class="${
            "block relative text-xl hover:scale-[1.01] font-Poppins shadow-md " +
            escape($isDarkMode ? "hover:shadow-xl " : "hover:shadow-lg", true) +
            " rounded-2xl hover:rounded-3xl mx-auto py-10 px-5 sm:p-10 text-center duration-300 w-11/12 sm:w-[500px]"
          }"${add_attribute("style", `background:${$elementColor}`, 0)}>

      ${`${validate_component(MagicLinkSection, "MagicLinkSection").$$render(
        $$result,
        {},
        {},
        {}
        ...
        <p class="${"py-3"}"></p>
        ${validate_component(PhoneAuthSection, "PhoneAuthSection").$$render(
          $$result,
          {},
          {},
          {}
      ...
      ${validate_component(GoogleLoginButton, "GoogleLoginButton").$$render(
        $$result,
        {},
        {},
        {}
      )}
      ${validate_component(TwitterLoginButton, "TwitterLoginButton").$$render(
        $$result,
        {},
        {},
        {}
...
${
  $isLoggedIn
    ? `<logout-card class="${
        "relative block hover:scale-[1.01] font-Poppins shadow-md " +
        escape($isDarkMode ? "hover:shadow-xl " : "hover:shadow-lg", true) +
        " rounded-2xl hover:rounded-3xl mx-auto py-5 px-3 sm:p-7 text-center duration-300 w-11/12 sm:w-[500px]"
      }"${add_attribute(
        "style",
        `background:${$elementColor}`,
        0
      )}><p${add_attribute("this", loginWelcomeText, 0)}>Welcome User</p>
