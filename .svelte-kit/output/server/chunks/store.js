import {
  ...
  d as add_attribute,
  e as escape,
  k as get_store_value,
} from "./index.js";
import { d as derived, w as writable } from "./index2.js";
let size$3 = 20;
const IconLogin = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    return `<svg class="${"scale-[1.5] origin-top bg-"}"${add_attribute(
      "width",
      size$3,
      0
    )}${add_attribute("height", size$3, 0)} viewBox="${
      "0 0 " + escape(size$3, true) + " " + escape(size$3, true)
    }"><path${add_attribute("class", navIconClickedFill, 0)}${add_attribute(
      "fill",
      fillColor,
      0
    )} d="${"M14 10L8 5v3H1v4h7v3l6-5zm3 7H9v2h8c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2H9v2h8v14z"}"></path></svg>`;
  }
);
let size$2 = 489.2;
const IconPlans = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let navIconClickedFill;
    let fillColor;
    let $isDarkMode, $$unsubscribe_isDarkMode;
...
<svg${add_attribute("height", size$2 / 15, 0)}${add_attribute(
      "width",
      size$2 / 15,
      0
    )} viewBox="${
      "0 0 " + escape(size$2, true) + " " + escape(size$2, true)
    }"><path${add_attribute("class", navIconClickedFill, 0)}${add_attribute(
      "fill",
      fillColor,
      0
...
let size$1 = 204.376;
const IconHomework = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let navIconClickedFill;
    let fillColor;
    let $isDarkMode, $$unsubscribe_isDarkMode;
...
<svg${add_attribute("height", size$1 / 7, 0)}${add_attribute(
      "width",
      size$1 / 7,
      0
    )} viewBox="${
      "0 0 " + escape(size$1, true) + " " + escape(size$1, true)
    }"><path${add_attribute("class", navIconClickedFill, 0)}${add_attribute(
      "fill",
      fillColor,
      0
...
let size = 31.886;
const IconClassroom = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let navIconClickedFill;
    let fillColor;
    let $isDarkMode, $$unsubscribe_isDarkMode;
    ...
    return `<svg${add_attribute("width", size, 0)}${add_attribute(
      ...
      "0 0 " + escape(size, true) + " " + escape(size, true)
    }"><g><path${add_attribute("class", navIconClickedFill, 0)}${add_attribute(
      "fill",
      fillColor,
      0
