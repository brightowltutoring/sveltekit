...
const GoogleLogo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
const EmailLogo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
const LoginCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="${"logInDiv p-5"}"><div class="${"bg-[#4285f4] hover:shadow-md hover:scale-105 duration-200 rounded-md p-4 " + escape(
    ...
    true
      ...
      <signin-button class="${"flex justify-center items-center gap-5"}">${validate_component(GoogleLogo, "GoogleLogo").$$render($$result, {}, {}, {})}
    ...
    true
  ) + " text-xl text-white"}"><signin-button class="${"flex justify-center items-center gap-5"}">${validate_component(EmailLogo, "EmailLogo").$$render($$result, {}, {}, {})}
...
${$$result.head += `<!-- HEAD_svelte-mdpg60_START --><link rel="${"preconnect"}" href="${"https://fonts.googleapis.com"}"><link rel="${"preconnect"}" href="${"https://fonts.gstatic.com"}" crossorigin><link href="${"https://fonts.googleapis.com/css2?family=Nunito:wght@200&family=Poppins:wght@100&display=swap"}" rel="${"stylesheet"}">${each(Object.keys($routes), (key) => {
      return `${$page.routeId.slice(1) == "" ? `${$$result.title = `<title>${escape($routes.home.title)}</title>`, ""}` : `${$page.routeId.slice(1) == key ? `${$$result.title = `<title>${escape($routes[key].title)}</title>`, ""}` : ``}`}`;
    })}<!-- HEAD_svelte-mdpg60_END -->`, ""}
