import { c as create_ssr_component, e as escape, a as subscribe, d as add_attribute, f as set_store_value, v as validate_component, g as getContext, h as now, l as loop, j as each } from "../../chunks/index.js";
...
${$$result.head += `<!-- HEAD_svelte-1yezitl_START --><link rel="${"preconnect"}" href="${"https://fonts.googleapis.com"}"><link rel="${"preconnect"}" href="${"https://fonts.gstatic.com"}" crossorigin><link href="${"https://fonts.googleapis.com/css2?family=Nunito:wght@200&family=Poppins:wght@100&display=swap"}" rel="${"stylesheet"}">${each(Object.keys($routes), (key) => {
