...
import {
  n as navLoginClicked,
  i as isLoggedIn,
  a as isDarkMode,
  e as elementColor,
  b as navHomeworkClicked,
  r as routes,
  s as scrollY,
  c as instDeltaY,
  l as lessThan768,
  w as windowInnerHeight,
  d as scrollYMax,
  f as innerWidth,
...
<modal-container class="${
    "fixed w-full h-full flex justify-center items-center z-[50] md:py-4 py-1 md:px-[7%] " +
    escape(showModal ? `${bgTint}` : "hidden", true)
  }">${slots.default ? slots.default({}) : ``}</modal-container>`;
});
function guard(name) {
  return () => {
...
const IconGoogle = create_ssr_component(
...
const IconEmail = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
...
const LoginCard = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let shortPing;
    ...
    $$unsubscribe_navLoginClicked = subscribe(
      navLoginClicked,
      (value) => ($navLoginClicked = value)
    );
    ...
    $$unsubscribe_elementColor = subscribe(
      elementColor,
      (value) => ($elementColor = value)
    );
    let emailFieldValue = "";
    ...
    return `<card class="${
      "hover:scale-[102%] font-Poppins shadow-md " +
      escape($isDarkMode ? "hover:shadow-xl " : "hover:shadow-lg", true) +
      " rounded-2xl hover:rounded-3xl mx-auto min-w-fit w-full sm:max-w-lg p-10 m-1 text-center duration-300 group"
    }"${add_attribute("style", `background:${$elementColor}`, 0)}>
  <div class="${"logInDiv p-5"}"><div class="${
      "bg-[#4285f4] hover:shadow-md hover:scale-105 duration-200 rounded-md p-4 " +
      escape(
      ...
      <signin-button class="${"flex justify-center items-center gap-5"}">${validate_component(
      IconGoogle,
      "IconGoogle"
    ).$$render($$result, {}, {}, {})}
    ...
    <div id="${"passwordlessLoginBtn"}" class="${
      "bg-red-400 hover:shadow-md hover:scale-105 duration-200 rounded-md p-4 " +
      escape(
    ...
    <input class="${
      "text-center p-3 mt-3 w-full " + escape(shortPing, true)
    }" id="${"emailField"}" type="${"email"}" placeholder="${"email"}"${add_attribute(
      "value",
      emailFieldValue,
      0
    )}>
...
const IconMoon = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
...
const LightDarkMode = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $isDarkMode, $$unsubscribe_isDarkMode;
    $$unsubscribe_isDarkMode = subscribe(
      isDarkMode,
    ...
    return `<button>${
      $isDarkMode
        ? `${validate_component(IconSun, "IconSun").$$render(
            $$result,
            {},
            {},
            {}
          )}`
        : `${validate_component(IconMoon, "IconMoon").$$render(
            $$result,
            {},
            {},
            {}
...
const Navitem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_navHomeworkClicked = subscribe(
    navHomeworkClicked,
    (value) => value
  );
  ...
  if (
    $$props.btnColorHover === void 0 &&
    $$bindings.btnColorHover &&
    btnColorHover !== void 0
  )
  ...
  $$unsubscribe_navLoginClicked();
  return `<button class="${
    escape(bool && `${btnColor} border-b-1 rounded px-3 py-1`, true) +
    " flex justify-center px-2 mx-1 font-Nunito md:text-xl text-2xl selection:bg-transparent " +
    escape(`${btnColorHover}`, true) +
    " hover:rounded hover:py-1 hover:p-3 duration-300 hover:shadow-lg"
  }">${escape(content)}</button>`;
});
...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    {
      $isLoggedIn
        ? set_store_value(routes, ($routes.login.name = "\u{1F680}"), $routes)
        : set_store_value(routes, ($routes.login.name = "Login"), $routes);
    }
  ...
  <nav class="${
    "md:ml-24 md:p-1 p-3 " +
    escape(bgGradientColor, true) +
    " rounded-md md:rounded-xl hideScrollBar overflow-auto"
        ...
        <li class="${"px-3 translate-y-1"}">${validate_component(
      LightDarkMode,
      "LightDarkMode"
    ).$$render($$result, {}, {}, {})}</li></ul></nav></logo-and-navbar>`;
  } while (!$$settled);
  $$unsubscribe_isDarkMode();
  $$unsubscribe_routes();
  $$unsubscribe_navHomeworkClicked();
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_instDeltaY = subscribe(
    instDeltaY,
    (value) => ($instDeltaY = value)
  );
  $$unsubscribe_scrollY = subscribe(scrollY, (value) => ($scrollY = value));
  $$unsubscribe_lessThan768 = subscribe(
    lessThan768,
    (value) => ($lessThan768 = value)
  );
  $$unsubscribe_windowInnerHeight = subscribe(
    windowInnerHeight,
    (value) => value
  );
  ...
  $$unsubscribe_navHomeworkClicked = subscribe(
    navHomeworkClicked,
    (value) => ($navHomeworkClicked = value)
  );
  let jankytown;
  let $$settled;
  let $$rendered;
  do {
    ...
    }
    {
      if ($lessThan768) {
        if ($scrollY == 0) {
          jankytown =
            "bottom-0 backdrop-blur-3xl md:top-0 md:backdrop-blur-3xl ";
        }
...
${
  (($$result.head += `<!-- HEAD_svelte-e21tyb_START --><link rel="${"preconnect"}" href="${"https://fonts.googleapis.com"}"><link rel="${"preconnect"}" href="${"https://fonts.gstatic.com"}" crossorigin><link href="${"https://fonts.googleapis.com/css2?family=Nunito:wght@200&family=Poppins:wght@100&display=swap"}" rel="${"stylesheet"}">${each(
    Object.keys($routes),
    (key) => {
      return `${
        $page.routeId == "/"
...
<main>${validate_component(Modal, "Modal").$$render(
      ...
      {
        default: () => {
          return `${validate_component(LoginCard, "LoginCard").$$render(
            $$result,
            {},
            {},
            {}
  ...
  <div class="${
    "md:py-4 py-1 md:px-[7%] z-50 fixed " +
    escape(jankytown, true) +
    " ease-in-out overflow-x-auto overflow-y-hidden w-full"
