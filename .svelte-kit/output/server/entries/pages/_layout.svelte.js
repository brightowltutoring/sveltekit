...
<svg aria-label="Moon" id="darkIcon"${I("height",q,0)}${I("width",q,0)} class="mx-3"><path d="M12 3a9 9 0 1 0 9 9c0-.46-.04-.92-.1-1.36a5.389 5.389 0 0 1-4.4 2.26 5.403 5.403 0 0 1-3.14-9.8c-.44-.06-.9-.1-1.36-.1Z"></path></svg>`);const he={code:":root{--light:#f7f7f7;--dark:rgb(20, 13, 33)}body{background:var(--light);color:var(--dark);transition:background-color 0.3s}body.dark-mode{background:var(--dark);color:var(--light)}",map:null},$e=D((e,o,t,b)=>{let a,s;return s=c(B,u=>a=u),e.css.add(he),s(),`
  <div><button>${a?`${k(be,"IconSun").$$render(e,{},{},{})}`:`${k(me,"IconMoon").$$render(e,{},{},{})}`}</button></div>`});function ne(){let e=Z,o=Z,t=["Macintosh","MacIntel","MacPPC","Mac68K"],b=["Win32","Win64","Windows","WinCE"],a=["iPhone","iPad","iPod"],s=null;return t.includes(o)?s="Mac OS":a.includes(o)?s="iOS":b.includes(o)?s="Windows":/Android/.test(e)?s="Android":/Linux/.test(o)&&(s="Linux"),s}function Y(){return Z}function ge(e="dropzoneCSS",o="/dropzone.css"){if(!document.getElementById(e)){const t=document.createElement("link");t.id=e,t.href=o,t.rel="stylesheet",document.head.appendChild(t)}}const ve=()=>{const e=le("__svelte__"),o={page:{subscribe:e.page.subscribe},navigating:{subscribe:e.navigating.subscribe},updated:e.updated};return Object.defineProperties(o,{preloading:{get(){return console.error("stores.preloading is deprecated; use stores.navigating instead"),{subscribe:e.navigating.subscribe}},enumerable:!1},session:{get(){return we(),{}},enumerable:!1}}),o},ie={subscribe(e){return ve().page.subscribe(e)}};function we(){throw new Error("stores.session is no longer available. See https://github.com/sveltejs/kit/discussions/5883")}const xe=D((e,o,t,b)=>{let a,s,u,m;a=c(G,r=>r),s=c(P,r=>r),m=c(ie,r=>u=r);let{href:n,content:p,routes:d,btnColorHover:h,icon:v,navIconClicked:$=!1}=o;o.href===void 0&&t.href&&n!==void 0&&t.href(n),o.content===void 0&&t.content&&p!==void 0&&t.content(p),o.routes===void 0&&t.routes&&d!==void 0&&t.routes(d),o.btnColorHover===void 0&&t.btnColorHover&&h!==void 0&&t.btnColorHover(h),o.icon===void 0&&t.icon&&v!==void 0&&t.icon(v),o.navIconClicked===void 0&&t.navIconClicked&&$!==void 0&&t.navIconClicked($);let w,x;do{w=!0;for(let r in d)d[r].isCurrent=d[r].href===u.url.pathname;x=`<a data-sveltekit-preload-data${I("href",n,0)} class="${"block font-Nunito font-thin "+g(` ${h}  hover:rounded py-1 px-2 duration-300 ease-in-out text-2xl md:text-xl`,!0)}">
  ${`${g(p)}`}</a>`}while(!w);return a(),s(),m(),x});function J(e){return Object.prototype.toString.call(e)==="[object Date]"}function U(e,o,t,b){if(typeof t=="number"||J(t)){const a=b-t,s=(t-o)/(e.dt||1/60),u=e.opts.stiffness*a,m=e.opts.damping*s,n=(u-m)*e.inv_mass,p=(s+n)*e.dt;return Math.abs(p)<e.opts.precision&&Math.abs(a)<e.opts.precision?b:(e.settled=!1,J(t)?new Date(t.getTime()+p):t+p)}else{if(Array.isArray(t))return t.map((a,s)=>U(e,o[s],t[s],b[s]));if(typeof t=="object"){const a={};for(const s in t)a[s]=U(e,o[s],t[s],b[s]);return a}else throw new Error(`Cannot spring ${typeof t} values`)}}function ke(e,o={}){const t=pe(e),{stiffness:b=.15,damping:a=.8,precision:s=.01}=o;let u,m,n,p=e,d=e,h=1,v=0,$=!1;function w(r,f={}){d=r;const _=n={};return e==null||f.hard||x.stiffness>=1&&x.damping>=1?($=!0,u=V(),p=r,t.set(e=d),Promise.resolve()):(f.soft&&(v=1/((f.soft===!0?.5:+f.soft)*60),h=0),m||(u=V(),$=!1,m=ae(y=>{if($)return $=!1,m=null,!1;h=Math.min(h+v,1);const T={inv_mass:h,opts:x,settled:!0,dt:(y-u)*60/1e3},S=U(T,p,e,d);return u=y,p=e,t.set(e=S),T.settled&&(m=null),!T.settled})),new Promise(y=>{m.promise.then(()=>{_===n&&y()})}))}const x={set:w,update:(r,f)=>w(r(d,e),f),subscribe:t.subscribe,stiffness:b,damping:a,precision:s};return x}const ye=D((e,o,t,b)=>{let a,s,u,m,n,p,d,h,v,$,w,x,r,f,_,y,T,S;u=c(B,l=>s=l),m=c(te,l=>l),p=c(R,l=>n=l),h=c(oe,l=>d=l),$=c(se,l=>v=l),x=c(de,l=>w=l),y=c(P,l=>_=l),S=c(G,l=>T=l);let H=ke(1,{stiffness:.1,damping:.25});f=c(H,l=>r=l);let A=0,O="sm:bg-red-300 rounded",M="hover:bg-red-300 ",W=ne()!=="iOS"&&"hidden",j=Y(),z=Z,C,i;do C=!0,d&&!Y()&&(A=s?.75:0,H.set(1+.5*Math.sin(v))),d?F(R,n.login.name="\u{1F680}",n):F(R,n.login.name="Login",n),a=`bg-gradient-to-r from-[rgba(0,0,0,0)] via-[rgba(0,0,0,0)]  ${s?"to-[rgb(37,35,91)]":"to-red-200"}`,i=`
<logo-and-navbar class="${"opacity-0 "+g(z,!0)+" flex items-center justify-center gap-x-32 md:justify-between w-full"}"><button class="p-2 md:translate-y-[0.1rem] md:translate-x-3 hidden md:block text-xl font-Poppins md:text-[min(5.5vw,40px)] active:text-red-600 hover:scale-110 transition-transform selection:bg-transparent">THINKSOLVE
  ...
  <ul class="${"text-xl grid grid-flow-col place-items-center w-full gap-1 p-2 rounded-md md:rounded-xl md:ml-24 md:p-1 md:w-auto "+g(a,!0)+" hideScrollBar overflow-x-scroll overflow-y-hidden"}">
    ...
    <li class="${"py-2 translate-y-1 scale-125 md:scale-100 "+g(j,!0)}">${k($e,"LightDarkMode").$$render(e,{},{},{})}</li></ul></logo-and-navbar>`;while(!C);return u(),m(),p(),h(),$(),x(),f(),y(),S(),i});async function Me(){if(!globalThis.submitOnce){const{PUBLIC_UPLOAD_ENDPOINT:e}=await import("../../chunks/public.js"),o=e,t=new FormData,b=new File(["foo"],"foo.txt",{type:"text/plain"});t.append("file",b),fetch(o,{method:"POST",body:t}),globalThis.submitOnce=!0}}const _e=D((e,o,t,b)=>{let a,s;return s=c(P,u=>a=u),a&&Me(),s(),`


`});const Te={code:".dropzone .dz-preview.dz-image-preview{background-color:transparent !important}",map:null};function Ce(){globalThis.onceBoolean||(setTimeout(()=>{document.querySelector(".dropzone").dispatchEvent(new CustomEvent("click"))},25),globalThis.onceBoolean=!0)}const De=D((e,o,t,b)=>{let a,s,u,m,n;u=c(P,r=>s=r),n=c(B,r=>m=r);let{text:p="\u{1F525}"}=o,{textSizeTW:d="text-3xl"}=o,{dimensionsTW:h="w-[65vw] sm:w-[60vw] h-[60vh]"}=o,{brightnessTW:v="brightness-100"}=o,$;async function w(r){console.log("drop it like its \u{1F525}"),ge("dropzoneCSS","/dropzone.css");const{PUBLIC_UPLOAD_ENDPOINT:f}=await import("../../chunks/public.js"),{Dropzone:_}=await import("dropzone");$=new _(r,{url:f,acceptedFiles:".heic,.jpeg,.jpg,.png,.txt,.pdf,.docx,.doc"}),x()}function x(){let r=[];$.on("error",f=>f.accepted&&r.push(f)),$.on("queuecomplete",()=>{setTimeout(()=>F(P,s=!1,s),1e3)}),window==null||window.addEventListener("online",()=>{if(r.length>0)for(const f of r)$.processFile(f),f.previewElement.querySelector(".dz-error-mark").style.visibility="hidden",f.previewElement.querySelector(".dz-error-message").style.visibility="hidden"})}return o.text===void 0&&t.text&&p!==void 0&&t.text(p),o.textSizeTW===void 0&&t.textSizeTW&&d!==void 0&&t.textSizeTW(d),o.dimensionsTW===void 0&&t.dimensionsTW&&h!==void 0&&t.dimensionsTW(h),o.brightnessTW===void 0&&t.brightnessTW&&v!==void 0&&t.brightnessTW(v),e.css.add(Te),s&&Ce(),a=m?"#1d1c43":"#ddd",u(),n(),`${k(_e,"PostDummyOnce").$$render(e,{},{},{})}


${k(re,"InView").$$render(e,{single:!0,onview:r=>w(r),once:!0,margin:"0px"},{},{default:()=>`<form method="post" style="${"box-shadow: inset 0 -10px 10px "+g(a,!0)+"; border-radius: 50px; border-color: transparent; background-color: transparent"}" class="${"dropzone flex justify-center items-center flex-wrap overflow-scroll backdrop-blur-3xl "+g(v,!0)+" "+g(d,!0)+" "+g(h,!0)+" mx-auto group"}"><div class="dz-message font-Nunito group-hover:animate-pulse" data-dz-message>${g(p)}</div></form>`})}`});let Q=800,X=400;const K=100,Oe=D((e,o,t,b)=>{let a,s,u,m,n,p,d,h,v,$,w,x,r,f,_,y,T,S,H,A;s=c(oe,i=>a=i),m=c(G,i=>u=i),p=c(ce,i=>n=i),h=c(se,i=>d=i),$=c(ue,i=>v=i),x=c(ie,i=>w=i),f=c(R,i=>r=i),y=c(B,i=>_=i),S=c(te,i=>T=i),A=c(P,i=>H=i);let O,M,W=!1,j,z,C;do z=!0,v||(d<10&&(M="top-0"),d>10&&d<Q&&(M="top-0 backdrop-blur-3xl duration-1000"),d>Q&&n>10&&(M="-top-20 backdrop-blur-3xl duration-200"),n<-100&&(M="top-0 backdrop-blur-3xl duration-700")),v&&(d>=0&&d<X&&(M="bottom-0 backdrop-blur-3xl md:top-0 md:backdrop-blur-3xl duration-200"),d>X&&n>20&&(M="-bottom-28 duration-400"),n<-30&&(M="bottom-0 backdrop-blur-3xl duration-700")),u&&!a&&setTimeout(()=>{j="opacity-100 transition-opacity duration-100 ease-in"},K),C=`
${e.head+=`<!-- HEAD_svelte-1le8ayz_START --><link rel="manifest" href="/manifest.json">${w.status==200?(()=>{let i=w.route.id.slice(1);return`
    ...
    ${i==""?`${e.title=`<title>${g(r.home.title)}</title>`,""}
      ...
      `:`${ee(Object.keys(r).slice(1),l=>{let L=r[l].title;return`
        ...
        ${i.startsWith(l)?`${e.title=`<title>${g(L)}</title>`,""}
          ...
          ${r[l].meta?`<!-- HTML_TAG_START -->${r[l].meta}<!-- HTML_TAG_END -->`:""}`:""}`})}`}`})():`${w.status==404?`${e.title="<title>Oops \u{1F4A9}</title>",""}`:""}`}<!-- HEAD_svelte-1le8ayz_END -->`,""}
...
<main>${k(E,"Modal").$$render(e,{showModal:W,bgTint:"backdrop-blur-3xl"},{},{default:()=>`<ul class="${"text-center flex flex-col gap-y-2 font-Poppins sm:text-5xl text-3xl text-transparent bg-clip-text bg-gradient-to-r "+g(_?"from-teal-200 via-rose-300 to-pink-200 ":"from-teal-700 via-rose-700 to-pink-700 ",!0)}"><li>Email:</li>
  ...
  ${k(E,"Modal").$$render(e,{body:!0,bgTint:`backdrop-blur-md opacity-0 ${j}`,showModal:u},{showModal:i=>{u=i,z=!1}},{default:()=>`
    ${k(fe,"LazyMount").$$render(e,{Import:()=>(setTimeout(()=>u=!0,2.5*K),import("../../chunks/LoginCard.js"))},{},{})}`})}

  ${k(E,"Modal").$$render(e,{bgTint:"bg-[rgba(0,0,0,0.1)]",showModal:H},{showModal:i=>{H=i,z=!1}},{default:()=>`${k(De,"Dropzone").$$render(e,{textSizeTW:"text-6xl",dimensionsTW:"w-[80vw] h-[85vh]",brightnessTW:"brightness-95"},{},{})}
  ...
  <div class="px-[7%] pt-32 md:block">${b.default?b.default({}):""}
    ...
    </div></main>`;while(!z);return s(),m(),p(),h(),$(),x(),f(),y(),S(),A(),C});export{Oe as default};
