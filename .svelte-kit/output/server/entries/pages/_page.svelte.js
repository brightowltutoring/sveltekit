...
${`<div class="grid grid-cols-1 gap-y-52 lg:gap-y-64">
    ...
    <div id="step1" class="hover:scale-105 duration-500 grid place-content-center"><button class="text-5xl font-Poppins text-center pb-7"><span class="${i(u(e),!0)+" svelte-iq6ytm"}">1. Upload your homework </span></button>

      
      
      <button style="${"box-shadow: inset 0 -10px 10px "+i(n,!0)+"; border-radius: 50px; border-color: transparent; background-color: transparent"}" class="flex justify-center items-center flex-wrap overflow-scroll backdrop-blur-3xl text-3xl w-[65vw] sm:w-[60vw] h-[60vh] mx-auto group"><div class="font-Nunito group-hover:animate-pulse text-2xl">Drop it like it&#39;s \u{1F525}
        </div></button></div>

    
    <div id="step2" class="duration-500 grid place-content-center"><button class="text-5xl font-Poppins text-center pb-7 "><span class="${i(u(e),!0)+" svelte-iq6ytm"}">2. Schedule a Session </span></button>

      
      ${c(b,"LazyMount").$$render(s,{Import:async()=>await import("../../chunks/PlansComponent.js")},{},{})}
    ...
    <div id="reviews" class="duration-500 mb-[200px] sm:mb-[500px]"><button class="text-5xl font-Poppins w-full flex justify-center"><span class="${i(u(e),!0)+" svelte-iq6ytm"}">3. Do Some Reading <span class="text-black">\u{1F60E} </span></span></button>

      ${c(I,"Reviews").$$render(s,{},{},{})}
