...
var Zt = class {
  constructor(t, e = null, n = [], r = [], s = null, i = null, o = null) {
    this.path = t, this.collectionGroup = e, this.orderBy = n, this.filters = r, this.limit = s, this.startAt = i, this.endAt = o, this.$ = null;
  }
};
...
var rn = class extends class {
  ...
  constructor(t, e, n, r) {
    super(), this.authCredentials = t, this.appCheckCredentials = e, this.tt = n, this.L = r, this.et = false;
  }
  nt() {
    if (this.et)
  ...
  I(t, e, n) {
    return this.nt(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([r, s]) => this.tt.I(t, e, n, r, s)).catch((t2) => {
  ...
  P(t, e, n, r) {
    return this.nt(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([s, i]) => this.tt.P(t, e, n, s, i, r)).catch((t2) => {
      throw "FirebaseError" === t2.name ? (t2.code === x && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t2) : new U(R, t2.toString());
    });
  }
  terminate() {
...
function An(t, e, ...n) {
  if (t = getModularInstance(t), 1 === arguments.length && (e = _t.D()), st("doc", "path", e), t instanceof fn) {
    const r = tt.fromString(e, ...n);
    return it(r), new vn(
      t,
      null,
...
var kn = class {
  constructor(t, e, n, r, s, i) {
    this.settings = t, this.databaseId = e, this.L = n, this.ignoreUndefinedProperties = r, void 0 === s && this.rt(), this.fieldTransforms = s || [], this.fieldMask = i || [];
  }
  get path() {
  ...
  lt(t) {
    return rr(t, this.settings.methodName, this.settings.ft || false, this.path, this.settings.dt);
  }
  contains(t) {
...
function Mn(t, e, n, r, s, i = {}) {
  ...
  let c, a;
  if (i.merge)
    c = new Dt(o.fieldMask), a = o.fieldTransforms;
    ...
    c = new Dt(t2), a = o.fieldTransforms.filter((t3) => c.covers(t3.field));
  } else
...
var Qn = class extends $n {
  ...
  _toFieldTransform(t) {
    const e = jn(
      ...
      t,
      true
    ), n = this.yt.map((t2) => Hn(t2, e)), r = new Te(n);
...
var zn = class extends $n {
  ...
  _toFieldTransform(t) {
    const e = jn(
      ...
      t,
      true
    ), n = this.yt.map((t2) => Hn(t2, e)), r = new Ae(n);
    return new Pe(t.path, r);
  }
  isEqual(t) {
    return this === t;
...
function Kn(t, e, n, r, s, i) {
  const o = t.wt(1, e, n), u = [tr(e, r, n)], c = [s];
  if (i.length % 2 != 0)
...
var Yr = class {
  constructor(t, e, n, r, s) {
    this.asyncQueue = t, this.datastore = e, this.options = n, this.updateFunction = r, this.deferred = s, this.Pt = n.maxAttempts, this.Vt = new nn(this.asyncQueue, "transaction_retry");
  }
  run() {
    this.Pt -= 1, this.Nt();
  }
  ...
  $t(t) {
    this.Pt > 0 && this.xt(t) ? (this.Pt -= 1, this.asyncQueue.enqueueAndForget(() => (this.Nt(), Promise.resolve()))) : this.deferred.reject(t);
  }
  xt(t) {
...
var Xr = class {
  constructor() {
    this.Ft = Promise.resolve(), this.St = [], this.qt = false, this.Ot = [], this.kt = null, this.Ct = false, this.Lt = false, this.Mt = [], this.Vt = new nn(this, "async_queue_retry"), this.Ut = () => {
      const t2 = Hr();
      t2 && y("AsyncQueue", "Visibility state changed to " + t2.visibilityState), this.Vt.Z();
    };
    const t = Hr();
  ...
  enqueue(t) {
    ...
    const e = new j();
    return this.Bt(() => this.qt && this.Lt ? Promise.resolve() : (t().then(e.resolve, e.reject), e.promise)).then(() => e.promise);
  }
  enqueueRetryable(t) {
  ...
  Bt(t) {
    const e = this.Ft.then(() => (this.Ct = true, t().catch((t2) => {
      this.kt = t2, this.Ct = false;
    ...
    }).then((t2) => (this.Ct = false, t2))));
    return this.Ft = e, e;
  }
  enqueueAfterDelay(t, e, n) {
    this.jt(), this.Mt.indexOf(t) > -1 && (e = 0);
    const r = Jr.createAndSchedule(this, t, e, n, (t2) => this.zt(t2));
  ...
  Kt(t) {
    return this.Gt().then(() => {
      this.Ot.sort((t2, e) => t2.targetTimeMs - e.targetTimeMs);
      for (const e of this.Ot)
