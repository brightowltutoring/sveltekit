<!-- <script>
	...
	$: fillColor = $isDarkMode ? 'yellow' : 'black';
</script> -->
...
<svg width="150" height="150" viewBox="0 0 1024 1024">
	...
	<!-- UPLOAD ICON PAGE ARROW -->
	<!-- <svg height="130" width="130" viewBox="0 0 485 485"> -->
	<!-- <path
		id="XMLID_448_"
...
<!-- this gradient-svg idea taken from: https://stackoverflow.com/questions/72212704/is-it-possible-to-fill-an-svg-with-a-gradient-color-or-background-image -->
<style>
	svg path {
		fill: url(#myGradient);
	}
