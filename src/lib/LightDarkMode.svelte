...
<button on:click={toggleDM} in:scale={{duration:1000, easing:elasticOut}} >
    {#if $isDarkMode }  
        <svg aria-label="Sun" id="lightIcon" height="24" width="24" viewBox="0 0 182 182" style="transform: scale(1);">
    ...
    {:else}             
        <svg aria-label="Moon" id="darkIcon" height="24" width="24" style="transform: scale(1);" data-metatip="true">
