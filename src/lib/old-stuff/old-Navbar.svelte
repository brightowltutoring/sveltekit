<script>
	...
	let fadeInToFullOpacity = browser && 'opacity-100 transition-opacity duration-1000 ease-in';
</script>
...
>
  ...
  > -->
      ...
      border-b-1 rounded "
		...
		<li class="py-2 translate-y-1 scale-125 md:scale-100 {hideIfRunningStandalone} ">
			<!-- <LightDarkMode /> -->
		</li>
	</ul>
</logo-and-navbar>
