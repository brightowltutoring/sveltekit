<script lang="ts">
	...
	import { loginModalOpen, homeworkModalOpen, navAppModalOpen } from '$lib/store/modalsStore';
...
<Modal
	all
	modalOpen={data.isIOS && $navAppModalOpen}
	on:closeModal={() => navAppModalOpen.set(false)}
...
<Modal
	transitionsOff
	modalOpen={$homeworkModalOpen}
	on:closeModal={() => homeworkModalOpen.set(false)}
