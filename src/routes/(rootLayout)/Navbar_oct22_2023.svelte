<script lang="ts">
	...
	import NavModals from './NavModals_oct22_2023.svelte';
	// import NavModals from './NavModals.svelte';
	import { loginModalOpen, homeworkModalOpen, clearNavModals } from '$lib/store/modalsStore';
	...
	>
		...
		{#each Object.values($routes).slice(1, 5) as { routePath, name, icon, isCurrent }}
			{@const navIconClicked =
				isCurrent ||
				(routePath === '/homework' && $homeworkModalOpen) ||
